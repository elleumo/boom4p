...
class SidePanel final : public sf::Drawable, private sf::NonCopyable {
	...
	// Range of players shown by this panel
	unsigned firstIdx = 0; // 0-based player index to start from
	unsigned count = 2;    // how many players to show (rows)
	bool alignRight = false; // draw this panel on the right side
